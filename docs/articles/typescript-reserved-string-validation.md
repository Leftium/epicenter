...
// '{ readonly __error: "\"id\" is reserved - auto-generated by system"; }'

text({ id: 'createdAt' });
// Type '"createdAt"' is not assignable to type
// '{ readonly __error: "\"createdAt\" is reserved - auto-generated by system"; }'

text({ id: '_private' });
// Type '"_private"' is not assignable to type
// '{ readonly __error: "\"_private\" - underscore prefix is internal"; }'

text({ id: '$computed' });
// Type '"$computed"' is not assignable to type
// '{ readonly __error: "\"$computed\" - dollar prefix is for computed fields"; }'
...
text({ id: 'id' });
// Type '"id"' is not assignable to type 'RESERVED_FIELD<"id", "auto-generated by system">'

text({ id: 'createdAt' });
// Type '"createdAt"' is not assignable to type 'RESERVED_FIELD<"createdAt", "auto-generated by system">'

text({ id: '_private' });
// Type '"_private"' is not assignable to type 'INTERNAL_FIELD<"_private">'

text({ id: '$computed' });
// Type '"$computed"' is not assignable to type 'COMPUTED_FIELD<"$computed">'
```
...
| ------------------ | -------------------------------- | ------------------- | --------------------- |
| `__error` property | `{ __error: "message" }`         | Property name       | None                  |
| Named error type   | `RESERVED_FIELD<"id", "reason">` | Type name           | None                  |
| Symbol brand       | `SchemaError<"CODE", "msg">`     | Symbol (guaranteed) | wellcrafted or inline |
...
When the expected parameter type is `never`, Y is "never" and the error is useless. When the expected type is an object containing your message, Y shows that object with your message inside.

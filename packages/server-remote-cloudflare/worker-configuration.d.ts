...
declare namespace Cloudflare {
	...
	interface Env {
		...
		YJS_ROOM: DurableObjectNamespace<import("./src/app").YjsRoom>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "BETTER_AUTH_SECRET" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY">> {}
}

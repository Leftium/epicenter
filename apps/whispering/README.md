...
**→ For GPU acceleration:** See the [Development Guide](./DEVELOPMENT.md#gpu-acceleration) for instructions on enabling Metal (macOS), CUDA/Vulkan (Windows), or CUDA/Vulkan/ROCm (Linux) support

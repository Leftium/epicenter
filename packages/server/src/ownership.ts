 ...
 *             ADR-0073); the operator bearer is the gate, so there is nobody
 *             to admit or reject at the partition boundary.
 *
 * Exactly two topologies, split on partition cardinality (ADR-0073): `personal`
 ...
 * stays decoupled from caller identity (ADR-0073).
 */

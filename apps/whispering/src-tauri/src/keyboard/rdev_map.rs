...
pub fn classify(key: rdev::Key) -> Option<Input> {
    ...
    let mapped = match key {
        R::KeyA => Key::KeyA, R::KeyB => Key::KeyB, R::KeyC => Key::KeyC,
        R::KeyD => Key::KeyD, R::KeyE => Key::KeyE, R::KeyF => Key::KeyF,
        R::KeyG => Key::KeyG, R::KeyH => Key::KeyH, R::KeyI => Key::KeyI,
        R::KeyJ => Key::KeyJ, R::KeyK => Key::KeyK, R::KeyL => Key::KeyL,
        R::KeyM => Key::KeyM, R::KeyN => Key::KeyN, R::KeyO => Key::KeyO,
        R::KeyP => Key::KeyP, R::KeyQ => Key::KeyQ, R::KeyR => Key::KeyR,
        R::KeyS => Key::KeyS, R::KeyT => Key::KeyT, R::KeyU => Key::KeyU,
        R::KeyV => Key::KeyV, R::KeyW => Key::KeyW, R::KeyX => Key::KeyX,
        R::KeyY => Key::KeyY, R::KeyZ => Key::KeyZ,
        ...
        R::F13 => Key::F13, R::F14 => Key::F14, R::F15 => Key::F15, R::F16 => Key::F16,
        R::F17 => Key::F17, R::F18 => Key::F18, R::F19 => Key::F19, R::F20 => Key::F20,
        R::F21 => Key::F21, R::F22 => Key::F22, R::F23 => Key::F23, R::F24 => Key::F24,
        R::Space => Key::Space,

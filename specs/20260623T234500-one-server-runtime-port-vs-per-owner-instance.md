...
- **Waves 1-4: LANDED (branch `wash-saddle`).** ADR-0059 is now `Accepted`.
...
Recorded as **[ADR-0059](../docs/adr/0059-runtime-portability-is-per-concern-injection-not-a-runtime-object.md)** (Proposed; flip to Accepted when the wave plan lands). The decision in one paragraph:

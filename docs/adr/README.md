...
| [0021](0021-a-conversation-has-one-transport-and-two-triggers.md) | A conversation has one transport (the synced doc) and two triggers; billing rides the inference backend; the second state owner is deleted, the inference endpoint kept | Proposed |

...
// ════════════════════════════════════════════════════════════════════════════
// DEFINE DOCUMENT — primitive types
// ════════════════════════════════════════════════════════════════════════════
 ...
 * extras (`whenLoaded`, `bind`). `handle.content.binding` reads better than
...
export type DocumentHandle<TAttach> = TAttach & {
	 ...
	 * bind during the grace window cancels the pending disposal.
	 */
	bind(): () => void;
};
...
export type DocumentFactory<Id extends string, TAttach> = {
	...
	/** Explicit eviction. Cancels any pending grace-period disposal. */

...
| `epicenter-icon-squircle.svg` | The mark on a black squircle. App icon and favicon shape. |
...
PNG is the committed raster format: it carries alpha and works everywhere as an
app icon, favicon, or social image. WebP/AVIF are not committed; add them only as
optional web-delivery copies if a site actually needs them.

...
**Status**: Draft
**Owner**: Braden
**Builds on**: `20260616T225034-always-on-workers-over-synced-docs.md` (the vision), `20260530T100000-ai-workflows-consolidated-design.md` (Model 1 / Model 2), `docs/adr/0010-actions-are-the-only-surface-that-crosses-a-process-boundary.md`, `docs/adr/0014-an-always-on-worker-runs-app-semantics-beside-the-app-blind-anchor.md`, `docs/adr/0015-agent-conversations-are-durable-child-docs-answered-by-workers.md`

...
export type Env = {
	...
	Variables: {
		 ...
		 * is never set on an instance, ADR-0075). Read by Better Auth and the room
		 ...
		 * route reads it (ADR-0075). Like every variable here, reading it before its
		 ...
		 * instance, which composes no Better Auth and reads no auth secret (ADR-0076).
		 */

...
5. Treat the app-blind anchor/sidecar and the app-aware worker (daemon) as separate roles with separate packaging. The sidecar multiplexes opaque rooms; the worker mounts an app workspace, observes its docs, and runs the app's actions as agent tools. Do not fold the worker into the sidecar. See ADR-0014.
...
- docs/adr/0014-an-always-on-worker-runs-app-semantics-beside-the-app-blind-anchor.md
- docs/adr/0015-agent-conversations-are-durable-child-docs-answered-by-workers.md
- docs/encryption.md

...
- **Only the star needs packaging.** Self-host delivery is the Bun star binary (ADR-0065); services need no packaging because they are called, not shipped.

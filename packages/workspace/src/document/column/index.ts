 ...
 * constraint plus the workspace's substrate-only builder (`nullable`). The
 * portable kinds are authored via `field.*` from `@epicenter/field` directly.
 *

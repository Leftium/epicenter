/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 06660cb1602d8e3e8ec011949ddf9e8c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		BETTER_AUTH_URL: "https://api.epicenter.so";
		DATABASE_URL: string;
		BETTER_AUTH_SECRET: string;
		YJS_ROOM: DurableObjectNamespace<import("./src/worker").YjsRoom>;
	}
}

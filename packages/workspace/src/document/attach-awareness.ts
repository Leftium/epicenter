 ...
 * Awareness teardown happens automatically when the underlying ydoc is
 * destroyed: y-protocols registers a `destroy` listener inside its own
 * constructor.
 *
 ...
 * than overwriting, so independent attachments coexist on one wire.
 *

...
/**
 * Browser tables — the complete schema for the tab manager workspace.
 *
 * This includes all table definitions used for syncing browser state
 * (tabs, windows, groups) across devices, plus explicitly saved suspended tabs.
 */

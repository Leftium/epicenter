...
Every V0 and V1 box ticked, and the V2.R research spec written. When that holds, report completion and propose flipping ADR-0012 and ADR-0013 from Proposed to Accepted.

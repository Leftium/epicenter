...
| [0014](0014-an-always-on-worker-runs-app-semantics-beside-the-app-blind-anchor.md) | An always-on worker runs app semantics beside the app-blind anchor | Proposed |
...
| [0015](0015-agent-conversations-are-durable-child-docs-answered-by-workers.md) | Agent conversations are durable child docs answered by workers | Proposed |

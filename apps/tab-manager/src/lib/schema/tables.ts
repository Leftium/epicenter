/**
 * Browser state table definitions.
 *
 * Defines the Yjs-backed tables for tabs, windows, tab groups, devices,
 * and suspended tabs. Used by both background and popup workspaces.
 *
